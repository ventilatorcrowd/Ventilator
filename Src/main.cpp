...
CUserInput UserInput("User Input"
        , 100
        , osPriorityNormal
        , (void *)UIStack
        , ARRAY_LEN(UIStack)
...
{
//    if(encoder.m_pHuart == huart)
//    {
//        encoder.writeUARTData(&huart->pRxBuffPtr[0], 1);
//    }
}
...
//    if(encoder.m_pHuart == huart)
//    {
//        encoder.writeUARTData(&huart->pRxBuffPtr[1], 1);
//    }
}
...
{
//    if(encoder.m_pSPI == hspi)
//    {
//        encoder.handleSPI(&hspi->pRxBuffPtr[0], 1);
//    }
}
