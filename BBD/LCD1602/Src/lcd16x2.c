...
//#define LCD16X2_PIN_EN LCD_EN_Pin
...
//    GPIO_InitStruct.GPIO_Pin = LCD16X2_PIN_RS | LCD16X2_PIN_RW | LCD16X2_PIN_EN;
...
//    if (data & 0x10) LCD16X2_GPIO_D7->BSRR = LCD16X2_PIN_D4;
    if (data & 0x80) HAL_GPIO_WritePin(LCD_D7_GPIO_Port, LCD_D7_Pin, GPIO_PIN_RESET);
    if (data & 0x40) HAL_GPIO_WritePin(LCD_D6_GPIO_Port, LCD_D6_Pin, GPIO_PIN_RESET);
    if (data & 0x20) HAL_GPIO_WritePin(LCD_D5_GPIO_Port, LCD_D5_Pin, GPIO_PIN_RESET);
    if (data & 0x10) HAL_GPIO_WritePin(LCD_D4_GPIO_Port, LCD_D4_Pin, GPIO_PIN_RESET);
...
//    if (data & 0x01) LCD16X2_GPIO_D7->BSRR = LCD16X2_PIN_D4;
    if (data & 0x08) HAL_GPIO_WritePin(LCD_D7_GPIO_Port, LCD_D7_Pin, GPIO_PIN_RESET);
    if (data & 0x04) HAL_GPIO_WritePin(LCD_D6_GPIO_Port, LCD_D6_Pin, GPIO_PIN_RESET);
    if (data & 0x02) HAL_GPIO_WritePin(LCD_D5_GPIO_Port, LCD_D5_Pin, GPIO_PIN_RESET);
    if (data & 0x01) HAL_GPIO_WritePin(LCD_D4_GPIO_Port, LCD_D4_Pin, GPIO_PIN_RESET);
    lcd16x2_toggle_e();
...
//    if (LCD16X2_GPIO_D7->IDR & LCD16X2_PIN_D7) data |= 0x80;
    ...
    if (HAL_GPIO_ReadPin(LCD_D5_GPIO_Port, LCD_D5_Pin)) data |= 0x20;
    if (HAL_GPIO_ReadPin(LCD_D6_GPIO_Port, LCD_D6_Pin)) data |= 0x40;
    if (HAL_GPIO_ReadPin(LCD_D7_GPIO_Port, LCD_D7_Pin)) data |= 0x80;
...
//    if (LCD16X2_GPIO_D7->IDR & LCD16X2_PIN_D7) data |= 0x08;
    if (HAL_GPIO_ReadPin(LCD_D4_GPIO_Port, LCD_D4_Pin)) data |= 0x01;
    if (HAL_GPIO_ReadPin(LCD_D5_GPIO_Port, LCD_D5_Pin)) data |= 0x02;
    if (HAL_GPIO_ReadPin(LCD_D6_GPIO_Port, LCD_D6_Pin)) data |= 0x04;
    if (HAL_GPIO_ReadPin(LCD_D7_GPIO_Port, LCD_D7_Pin)) data |= 0x08;
    // EN pin = LOW
//    LCD16X2_GPIO_EN->BSRR = LCD16X2_PIN_EN;
    HAL_GPIO_WritePin(LCD_EN_GPIO_Port, LCD_EN_Pin, GPIO_PIN_SET);
