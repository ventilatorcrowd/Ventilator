...
/**\brief   Gets the selected GPIO state
 *
 * \param   GPIOID  - GPIO to be checked
 *
 * \return  returns the state of the selected GPIO
 */
bool CGPIOData::getGPIOState(uint32_t GPIOID)
{
...
{
    bool temp ((m_changed & m_state) & GPIOID);
